...
Usage:
    ...
    uv run --python 3.11 --with numpy python scripts/benchmark_parallel_parse.py
    uv run --python 3.11 --with numpy python scripts/benchmark_parallel_parse.py --chunks 5000
    uv run --python 3.11 --with numpy python scripts/benchmark_parallel_parse.py --workers 2 4 8
"""
