...
Usage:
    ...
    uv run --python 3.11 --with numpy python benchmark_parser.py /path/to/file.stream
    uv run --python 3.11 --with numpy python benchmark_parser.py /path/to/file.stream -n 100
"""
